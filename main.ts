...
class SideroSingleNodeClusterStack extends RemoteBackendStack {
  ...
  constructor(scope: Construct, name: string) {
    ...
    const sideroVm = new ProxmoxTalosVirtualMachine(this, 'SideroVirtualMachine', {
      name: 'sidero',
      cores: 2,
      memory: 4,
      vlanTag: 100,
    ...
    const sideroVmUnifiUserData = new unifi.dataUnifiUser.DataUnifiUser(this, "SideroVirtualMachineUnifiUserData", {
    ...
    const sideroTalosClusterSingleNode = sideroTalosCluster.addControlPlaneNode('SideroSingleNode', sideroVmUnifiUserData.ip, 'sidero');
    sideroTalosCluster.bootStrap(sideroTalosClusterSingleNode);
    const sideroTalosClusterKubeConfig = sideroTalosCluster.getKubeConfig(sideroTalosClusterSingleNode);
